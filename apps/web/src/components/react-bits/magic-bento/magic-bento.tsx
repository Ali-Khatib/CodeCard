...
const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const cards = grid.querySelectorAll('.card, .bento-tile');
    ...
    const handleMouseLeave = () => {
      ...
      gridRef.current?.querySelectorAll('.card, .bento-tile').forEach(card => {
        (card as HTMLElement).style.setProperty('--glow-intensity', '0');
      });
...
export { GlobalSpotlight, ParticleCard, BentoCardGrid, useMobileDetection, MOBILE_BREAKPOINT };
