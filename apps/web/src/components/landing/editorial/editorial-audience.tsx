...
function PersonaPanel({
  ...
  return (
    <article className="cc-ed-audience__panel" data-audience-card={persona.id}>
...
/**
 * Who CodeCard is for — overlapping persona strip.
 * Vertical scroll moves the track sideways. Neighbors stay in frame.
 */
      ...
      gsap.fromTo(
        ...
        { x: 0 },
        {
          ...
          scrollTrigger: {
            ...
            trigger: pin,
            start: 'top top',
            end: () => `+=${Math.max(shift(), window.innerWidth * 0.8)}`,
            pin: true,
            scrub: 1,
            anticipatePin: 1,
