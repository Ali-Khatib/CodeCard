...
export function AuthShell({
  ...
  return (
    <div
      className="cc-marketing-shell relative z-[1] min-h-screen overflow-hidden bg-[#fcf1e7]"
      data-testid="auth-shell"
      data-auth-mode={mode}
    >
      <div className="relative z-[2] flex min-h-screen w-full flex-col lg:flex-row">
        <div className="relative hidden min-h-screen w-[60%] max-w-[60%] lg:block">
          <AuthShowcaseStage />
        </div>

        <div className="relative px-5 pb-2 pt-6 lg:hidden">
          <AuthWordmark />
        </div>
