...
export const MUTATION_FEEDBACK = {
  ...
  schedule: {
    ...
    followUpDeleted: 'Follow-up removed',
    followUpUpdateFailed: 'We could not update that follow-up. Try again.',
    followUpDeleteFailed: 'We could not remove that follow-up. Try again.',
  },
