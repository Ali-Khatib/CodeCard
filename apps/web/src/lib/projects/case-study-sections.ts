...
export const CASE_STUDY_SECTIONS: CaseStudySectionConfig[] = [
  {
    ...
    addHint: 'Check Add, then write 1–3 sentences on what was broken or frustrating.',
  ...
  },
  {
    ...
    addHint: 'Check Add, then explain how you tackled it in a few sentences.',
  ...
  },
  {
    ...
    addHint: 'Check Add, then note the outcome: metrics, adoption, or wins.',
  ...
  },
  {
    ...
    label: 'Results',
    eyebrow: 'Proof',
    summary: 'A visual proof it worked — chart, metric, or before/after.',
    addHint: 'Check Add, then paste an image URL or upload a screenshot (max 400 KB).',
  ...
  },
  {
    ...
    label: 'Product',
    eyebrow: 'Interface',
    summary: 'A screenshot of the UI, app screen, or live experience.',
    addHint: 'Check Add, then paste an image URL or upload a UI screenshot.',
  ...
  },
  {
    ...
    addHint: 'Check Add, then paste an image URL or upload a diagram screenshot.',
